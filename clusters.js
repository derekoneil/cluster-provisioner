...
var privateKey = process.argv[8];
var tenancyOcid = process.argv[9];
var region = process.argv[10];

var clusterName = process.argv[11];
var k8Version = process.argv[12];
var compartment = process.argv[13];
var poolName = process.argv[14];
var shape = process.argv[15];
var imageName = process.argv[16];
var workersPerAd = process.argv[17];
var ads = process.argv[18].split(',');
var werckerUser = process.argv[19];
