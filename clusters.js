...
var werckerToken = process.argv[2];
var werckerOrgId = process.argv[3];
var credentialSetName = process.argv[4];
var userOcid = process.argv[5];
var fingerprint = process.argv[6];
var privateKey = process.argv[7];
